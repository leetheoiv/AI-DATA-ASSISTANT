...
class AgentState(TypedDict):
    ...
    # A clarifying question from the planner that needs to go back to the user
    # Set by planner node when action == CLARIFY
    # Cleared by supervisor node after it has been shown to the user
    planner_clarification: Optional[str]
